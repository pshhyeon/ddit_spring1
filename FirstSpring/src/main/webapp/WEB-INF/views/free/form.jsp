					...
					<div class="card-body">
						...
						<form method="post" action="/free/insert.do" id="freeForm" class="form-horizontal">
							...
							<div class="form-group row">
								...
								<font color="red" style="font-size: 14px;">${errors.freeTitle }</font>
							</div>
							<div class="form-group row mt-4">
								<label class="col-sm-2 control-label" >내용</label>
								<div class="col-sm-10">
									<textarea name="freeContent" id="freeContent" cols="50" rows="5" class="form-control" placeholder="내용을 입력해주세요.">${free.freeContent }</textarea>
...
$(function(){
	...
	addBtn.on("click", function(){
		var title = $("#freeTitle").val(); // 제목 값
		var content = CKEDITOR.instances.freeContent.getData(); // 내용 값
