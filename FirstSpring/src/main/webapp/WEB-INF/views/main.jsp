	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체 ${boardList.size() }건</span>
				</div>
			...
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체 ${noticeList.size() }건</span>
				</div>
				<form action="" method="post">
					<div style="padding-top: 50px">
						<table class="table">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체 ${freeList.size() }건</span>
				</div>
				<form action="" method="post">
					<div style="padding-top: 50px">
						<table class="table">
							...
							<tr>
								...
								<c:choose>
									...
									<c:otherwise>
										<c:forEach items="${freeList }" var="free" begin="0" end="4">
											<tr>
												<td>${free.freeNo }</td>
												<td> <a href="/free/detail.do?freeNo=${free.freeNo }">${free.freeTitle }</a> </td>
												<td>${free.freeDate }</td>
											</tr>
										</c:forEach>
									</c:otherwise>
