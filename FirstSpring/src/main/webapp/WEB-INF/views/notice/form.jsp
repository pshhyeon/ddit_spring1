...
<script type="text/javascript" src="${pagaeContext.request.contextPath }/resources/ckeditor/ckeditor.js"></script>
					...
					<div class="card-body">
						...
						<form method="post" action="/notice/insert.do" id="noticeForm" class="form-horizontal">
							...
							<div class="form-group row">
								...
								<font color="red" style="font-size: 14px;">${errors.noticeTitle }</font>
							</div>
							<div class="form-group row mt-4">
								<label class="col-sm-2 control-label" >내용</label>
								<div class="col-sm-10">
									<textarea name="noticeContent" id="noticeContent" cols="50" rows="5" class="form-control" placeholder="내용을 입력해주세요.">${notice.noticeContent }</textarea>
								</div>
								<font color="red" style="font-size: 14px;">${errors.noticeContent }</font>
							</div>
							<div class="form-group row mt-4">
...
$(function(){
	...
	addBtn.on("click", function(){
		var title = $("#noticeTitle").val(); // 제목 값
		var content = CKEDITOR.instances.noticeContent.getData(); // 내용 값
